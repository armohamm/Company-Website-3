      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Etusivun kuvien muokkaus</h1>
  
            <form class="" action="includes/edit-frontpage-img.inc.php" method="post" enctype="multipart/form-data">
