...
<head>
  ...
  <title>Adminsivusto - Pääsivun kuvien vaihtaminen</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Pääsivun kuvien vaihtaminen</h1>

          <form class="" action="change-photos.html" method="post">
            <h1 class="h4 mb-4 text-gray-800">Aloitus osion kuva</h1>
            <input type="file" name="file0"><br>
          
            <h1 class="h4 mb-4 text-gray-800" style="margin-top: 25px">Meistä osion kuva</h1>
